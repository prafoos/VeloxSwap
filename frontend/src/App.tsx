...
export default function App(): JSX.Element {
  ...
  return (
    <div className={`app-container velox-app tab-${activeTab}`}>
      <style>{`
        :root {
          --vx-bg: #030816;
          --vx-bg-2: #071126;
        ...
        @media (min-width: 821px) {
          ...
          .swap-mode-shell > .swap-card {
            /* Natural height: the whole card expands when quote details
               appear, rather than growing content inside a fixed card. */
            height: auto;
            min-height: 0;
            box-sizing: border-box;
            display: flex;
          ...
          .liquidity-mode-shell > .swap-card {
            /* Natural card height for Liquidity as well. */
            min-height: 0;
            height: auto;
            box-sizing: border-box;
            display: flex;
        ...
        /* ============================================================
           SWAP + LIQUIDITY DESKTOP VIEWPORT FIT
           Scoped ONLY to Swap and Liquidity tabs.
           Home / Stake / Faucet / Contact keep their existing layout.
           No internal vertical scrollbar is introduced.
           ============================================================ */
        @media (min-width: 821px) {
          .velox-app.tab-swap,
          .velox-app.tab-liquidity {
            height: 100vh;
            height: 100dvh;
            min-height: 0;
            overflow: hidden;
          ...
          .velox-app.tab-swap .vx-main,
          .velox-app.tab-liquidity .vx-main {
            flex: 1 1 auto;
            min-height: 0;
            overflow: hidden;
            display: flex;
          ...
          .velox-app.tab-swap .page-area,
          .velox-app.tab-liquidity .page-area {
            min-height: 0;
            height: auto;
            flex: 0 0 auto;
            padding: 10px 0 4px;
          ...
          .velox-app.tab-swap .card-mode-shell,
          .velox-app.tab-liquidity .card-mode-shell {
            margin: 0 auto;
          }

          .velox-app.tab-swap .mode-toggle-row,
          .velox-app.tab-liquidity .mode-toggle-row {
            margin-bottom: 8px;
          }

          .velox-app.tab-swap .swap-mode-shell > .swap-card,
          .velox-app.tab-swap .compact-mode-shell > .swap-card {
            /* Swap keeps a little more vertical breathing room on desktop.
               The card still grows naturally when quote details appear;
               nothing is clipped and there is no internal scrollbar. */
            height: auto;
            min-height: 390px;
          ...
          .velox-app.tab-swap .swap-card h2,
          .velox-app.tab-liquidity .swap-card h2 {
            font-size: 22px;
          }

          .velox-app.tab-swap .card-title-row,
          .velox-app.tab-liquidity .card-title-row {
            margin-bottom: 10px;
          }

          .velox-app.tab-swap .token-box,
          .velox-app.tab-liquidity .token-box {
            padding: 9px 14px 6px;
            border-radius: 12px;
          }

          .velox-app.tab-swap .balance-row,
          .velox-app.tab-liquidity .balance-row {
            margin-bottom: 5px;
          }

          .velox-app.tab-swap .token-input,
          .velox-app.tab-liquidity .token-input {
            font-size: 25px;
          }

          .velox-app.tab-swap .token-logo,
          ...
          .velox-app.tab-swap .token-selector,
          .velox-app.tab-liquidity .token-selector {
            min-width: 118px;
            padding: 6px 9px;
          }

          .velox-app.tab-swap .swap-arrow-wrap {
            height: 32px;
          }

          .velox-app.tab-swap .btn-switch-direction {
            width: 32px;
            height: 32px;
          }

          .velox-app.tab-swap .details-container,
          .velox-app.tab-liquidity .details-container {
            margin-top: 8px;
            padding: 7px 11px;
          }

          .velox-app.tab-swap .detail-item,
          .velox-app.tab-liquidity .detail-item {
            padding: 3px 0;
          }

          .velox-app.tab-swap .gas-warning {
            margin-top: 7px;
            padding: 7px 9px;
          }

          .velox-app.tab-swap .btn-action,
          ...
          .velox-app.tab-swap .swap-mode-shell > .swap-card .details-container {
            flex: none;
            box-sizing: border-box;
          }

          .velox-app.tab-liquidity .liquidity-mode-shell > .swap-card {
            /* Keep Liquidity vertically compact while still allowing the
          ...
          /* Keep the post-card information visible without pushing the
             page below the viewport. This dashboard is only compacted
             on Swap/Liquidity tabs. */
          .velox-app.tab-swap .status-stack,
          .velox-app.tab-liquidity .status-stack {
            width: min(100%, 560px);
            margin: 6px auto 0;
          }

          .velox-app.tab-swap .status-box,
          .velox-app.tab-liquidity .status-box {
            padding: 9px 12px;
          }

          /* Arc Wallet Balances follows the exact width of the active main card. */
          /* Stake tab: keep the main card and wallet balance panel compact and aligned. */
          .velox-app.tab-stake .swap-card.wide-card {
            width: min(100%, 660px);
          }

          .velox-app.tab-stake .balance-dashboard {
            width: min(100%, 660px);
            margin: 6px auto 8px;
            padding: 9px 12px;
            box-sizing: border-box;
          ...
          .velox-app.tab-stake .balance-dashboard h3 {
            margin-bottom: 6px;
          }

          .velox-app.tab-stake .balance-lines {
            gap: 3px;
          }

          .velox-app.tab-stake .balance-lines div {
            font-size: 10px;
          }

          /* Faucet tab: keep the main card and Arc Wallet Balances panel
             compact and aligned to the same desktop width.
             This is scoped only to Faucet; other tabs keep their existing layout. */
          .velox-app.tab-faucet .swap-card.wide-card {
            width: min(100%, 660px);
          }

          .velox-app.tab-faucet .balance-dashboard {
            width: min(100%, 660px);
            margin: 6px auto 8px;
            padding: 9px 12px;
            box-sizing: border-box;
          ...
          .velox-app.tab-faucet .balance-dashboard h3 {
            margin-bottom: 6px;
          }

          .velox-app.tab-faucet .balance-lines {
            gap: 3px;
          }

          .velox-app.tab-faucet .balance-lines div {
            font-size: 10px;
          }

          .velox-app.tab-swap .balance-dashboard {
            width: min(100%, 660px);
            margin: 6px auto 8px;
            padding: 9px 12px;
            box-sizing: border-box;
          ...
          .velox-app.tab-liquidity .balance-dashboard {
            width: min(100%, 720px);
            margin: 6px auto 8px;
            padding: 9px 12px;
            box-sizing: border-box;
          ...
          .velox-app.tab-swap .balance-dashboard h3,
          .velox-app.tab-liquidity .balance-dashboard h3 {
            margin-bottom: 6px;
          }

          .velox-app.tab-swap .balance-lines,
          .velox-app.tab-liquidity .balance-lines {
            gap: 3px;
          }

          .velox-app.tab-swap .balance-lines div,
          .velox-app.tab-liquidity .balance-lines div {
            font-size: 10px;
          }
        }
